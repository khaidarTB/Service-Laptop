<x-app-layout>
    ...
    {{-- Scope Alpine JS utama untuk mengontrol modal --}}
    <div class="space-y-6" x-data="{ open: false }">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <!-- Tombol Buka Modal -->
            <button type="button" @click="open = true" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-2xl font-bold text-sm transition shadow-lg shadow-blue-600/30 flex items-center justify-center gap-2 cursor-pointer">
                ...
                <div class="fixed inset-0 flex items-center justify-center p-4">
                    <div class="bg-white rounded-3xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto p-6" @click.stop>
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <button type="button" @click="open = false" class="p-2 text-slate-400 hover:text-slate-600 transition rounded-xl hover:bg-slate-100">
